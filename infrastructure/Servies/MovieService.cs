    ...
    public class MovieService : IMovieService
    {
        ...
        public async Task<MovieDetailsModel> GetMovieDetails(int id)
        {
            ...
            { 
                ...
                Revenue = movie.Revenue, Tagline = movie.Tagline, Title = movie.Title,
                ImdbUrl = movie.ImdbUrl, RunTime = movie.RunTime, BackdropUrl = movie.BackdropUrl,
            ...
            movieDetails.Cast = new List<CastModel>();
            foreach (var cast in movie.MovieCasts)
            {
                movieDetails.Cast.Add(new CastModel
                {
                    Id = cast.CastId, Character = cast.Character, Name = cast.Cast.Name,
